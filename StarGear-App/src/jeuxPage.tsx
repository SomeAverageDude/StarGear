        ...
        <div className="justify-content-center d-flex row pt-4">
          ...
          <div className="pt-2 ps-2 col-3" style={styleBorder}>
            <img
              ...
              width={350}
            ></img>
            <label>Par {jeux[0]?.developpeur} en {jeux[0]?.date_de_sortie}<br/> {jeux[0]?.description}</label>
          </div>
        </div>

        <div className="col-8 mt-3 mb-3">
          <div className="p-5" style={styleBorder}>
            <label className="col-9" style={{fontWeight: "bold", fontSize: 30}}>Acheter {jeux[0]?.nom_jeu} at {jeux[0]?.prix}$ Sale : {jeux[0]?.sale} %</label>
